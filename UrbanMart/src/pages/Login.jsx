    ...
    <div className="min-h-screen bg-linear-to-br from-[#fdf9f5] via-[#f5ede0] to-[#ede0cc] flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-[#C9B19420] border border-[#ede5da] overflow-hidden">
        ...
        <div className="px-8 py-9">
          ...
          >
            <input
              className="outline-none px-4 py-2 bg-slate-100 rounded-xl"
              label="Email"
              type="email"
            ...
            <button
              type="submit"
              className="mt-1 w-full cursor-pointer bg-[#1a1a1a] hover:bg-[#C9B194] text-white font-medium py-3.5 rounded-xl text-[14px] transition-colors duration-200"
            >
